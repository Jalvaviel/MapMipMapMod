...
public enum InvisibleFrames implements TranslatableOption {
    ...
    private static final IntFunction<InvisibleFrames> BY_ID = ValueLists.createIdToValueFunction(InvisibleFrames::getId, values(), ValueLists.OutOfBoundsHandling.WRAP);
